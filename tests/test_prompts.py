...
def test_system_prompt_is_model_neutral() -> None:
    text = SYSTEM_PROMPT.lower()

    assert "configured chat model" in text
...
def test_profile_sets_conservative_harness_rules() -> None:
    profile = QWEN_HARNESS_PROFILE

    assert profile["model_family"] == "configurable"
